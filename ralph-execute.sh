...
# Ralph Execute Loop Script for GitHub Copilot CLI
...
if ! command -v copilot &> /dev/null; then
    ...
    echo ""
    echo "See: https://docs.github.com/en/copilot/how-tos/use-copilot-agents/use-copilot-cli"
    exit 1
fi
...
# Display banner
echo -e "${BLUE}╔════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║    Ralph Wiggum Execution Loop - Copilot      ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════╝${NC}"
echo ""
