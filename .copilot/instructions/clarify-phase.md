# Ralph Clarify Phase Instructions for GitHub Copilot CLI
...
3. Tell the user the next step: "Run the plan phase: cat .copilot/instructions/plan-phase.md | copilot"

## File Format: clarify-session.md

Create and update this file throughout the session:
...
**Now, ask the user: "What would you like to build?" and begin the comprehensive interview.**
